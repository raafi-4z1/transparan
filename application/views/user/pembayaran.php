        ...
        <div class="col p-0">
            <div class="row m-2 mt-3 shadow-sm mb-4 rounded" style="background-color: rgb(177, 236, 247)">
                <div class="col" style="align-self: center;">
                    <p class="mb-0">Pembayaran yang sudah Lunas, dapat dilihat di "List Pembayaran"</p>
                    <?= $this->session->flashdata('message'); ?>
                </div>
                <div class="col-sm-3 p-2 text-end">
                    <a href="<?= base_url('user/listPembayaran'); ?>">
                        <button type="button" class="btn btn-primary btn-sm rounded-pill shadow">List Pembayaran</button>
                    </a>
                </div>
            </div>
                          ...
                          <td>
                            ...
                            <div class="d-inline-flex m-0 p-1 bd-highlight">
                                <a href="<?= base_url('user/--/'.$dk['id_pemesanan']); ?>">
                                    <button type="button" class="btn btn-primary btn-sm rounded-pill shadow wdth">Bayar</button>
                                </a>
                            </div>
                            <div class="d-inline-flex m-0 p-1 bd-highlight">
